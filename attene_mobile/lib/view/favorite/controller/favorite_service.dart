...
class FavoriteService {
  ...
  static Future<Map<String, dynamic>?> getFavoritesByType(String type,
  ...
  static Future<Map<String, dynamic>?> addFavorite(String type, String id, {String? listId}) async {
    return await ApiHelper.post(
      path: '/favorites/add',
      body: {'favs_type': type, 'favs_id': id, if (listId != null) 'list_id': listId},
    );
  }

  static Future<Map<String, dynamic>?> removeFavorite(String type, String id) async {
    return await ApiHelper.post(
  ...
  static Future<Map<String, dynamic>?> createFavoriteList(
      String name, String? description, bool isPrivate, String? type) async {
    return await ApiHelper.post(
      path: '/favorite-lists',
      body: {
        'name': name,
