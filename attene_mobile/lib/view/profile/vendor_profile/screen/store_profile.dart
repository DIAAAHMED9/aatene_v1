...
class _StoreProfilePageState extends State<StoreProfilePage> {
                ...
                return [
                  SliverAppBar(
                    ...
                    flexibleSpace: FlexibleSpaceBar(
                      background: GetBuilder<VendorProfileController>(
                        builder: (controller) {
                          ...
                          if (controller.coverUrls.isEmpty) {
                            return Image.asset(
                          ...
                          return Stack(
                            children: [
                              PageView.builder(
                                ...
                                itemCount: controller.coverUrls.length,
                                onPageChanged: controller.changePage,
                                itemBuilder: (context, index) {
                                  return Image.network(
                                    controller.coverUrls[index],
                                    fit: BoxFit.cover,
                  ...
                  SliverToBoxAdapter(
                    child: Transform.translate(
                      ...
                      child: _buildMainStoreCard(controller),
                    ),
                  ),
  ...
  Widget _buildMainStoreCard(VendorProfileController controller) {
    return Container(
          ...
          Row(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Text(
                    controller.storeData['name'] ?? "EtnixByron",
  ...
  Widget _bioCard(VendorProfileController controller) {
    return Column(
      spacing: 10,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ReadMoreText(
                controller.storeData['description'] ??
