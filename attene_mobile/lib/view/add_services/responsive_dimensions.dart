...
class ResponsiveDimensions {
  ...
  static double responsiveWidth(double mobile, [double? tablet, double? desktop]) {
    final context = Get.context;
  ...
  static double responsiveHeight(double mobile, [double? tablet, double? desktop]) {
    final context = Get.context;
    if (context == null) return mobile;
  ...
  static double responsiveFontSize(double mobile, [double? tablet, double? desktop]) {
    final context = Get.context;
    if (context == null) return mobile;
  ...
  static double responsiveRadius(double mobile, [double? tablet, double? desktop]) {
    return responsiveWidth(mobile, tablet, desktop);
  }

  static double responsiveSpace(double mobile, [double? tablet, double? desktop]) {
