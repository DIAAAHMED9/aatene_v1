...
class _ConversationAvatar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (!isGroup) {
      return _Avatar(url: mainUrl, isGroup: false, radius: 24);
    }
    ...
    if (urls.length < 2) {
      return _Avatar(url: mainUrl, isGroup: true, radius: 24);
    }
      ...
      child: Stack(
        children: [
          Positioned(
            left: 0,
            top: 6,
            child: _Avatar(url: urls[0], isGroup: false, radius: 18),
          ),
          Positioned(
            right: 0,
            bottom: 0,
            child: _Avatar(url: urls[1], isGroup: false, radius: 18),
          ),
        ],
      ),
    );
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, i) {
                    ...
                    return CheckboxListTile(
                      ...
                      secondary: _Avatar(url: avatar, isGroup: false),
                      title: Text(name),
                      subtitle: Text(type),
